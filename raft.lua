...
local function setup_gui_metro()
	local gui = metro.init()
	gui.time = 1 / 15
	gui.event = function()
...
local function setup_ocean_metro()
	timing = metro.init()
	timing.time = 1
...
function init()
	...
	params:add({ type = "number", id = "viewBrightness", name = "Brightness", min = 3, max = 15, default = 7 })
